...
Tags: group chat, chat, chatroom, members chat, chat room, community chat, online event, buddypress chat, chat box,bbpress chat, chat platform, ultimate member, chat members, video chat, social chat, discussion chat, team chat, html5 chat, chatroom widget, chat plugin, PeepSo chat, chat widget, chatbox, popup chat, mobile chat
...
Live group chat plugin for WordPress with polls. Integrate an online group chat for members only or a social open chat room on your website or for a live online events.
...
751,000 websites and online events are already using the <a href="https://rumbletalk.com/">RumbleTalk HTML Chat Platform</a>.
...
https://www.youtube.com/watch?v=70_zc1fvUtM
...
== Screenshots ==
1. The most advanced chat platfrom for wordpress with over then 706,000 installations, upload files, images and docs.
2. Chat chat skin with advanced design and css. You can share any type of file, image, video, links, or emojis to the group chat.
3. Moderated chat where you approve message before they show up. Let chat admins perform functions such as screening inbound messages before it goes live, limiting the users, banning a specific user, changing the chat type, exporting transcripts, filtering profanity, and more.
4. Polls provide streamlined audience feedback in real-time. Let your participants weigh in on the topic by getting their opinion through the polls feature.
5. Mention a User - Think of the Mentions feature as tagging someone. When you type @ in the chat room, you will see a list of users. This can help you better manage messages in the chat room.
6. Floating Chat - your messages appear as little popups. The most recent messages will remain in the bubble for users to view, and you can tap the bubble to open the conversation in a popup window. 
7. Video and Audio Call - Aside from sending text messages, you can also make private video and audio calls in the chat without having to install anything, making every conversation more personal and less virtual.
8. Keywords - RumbleTalk Keywords (InTEXT) identify specific words and dynamically turn them into clickable links, allowing you to redirect your audience to any webpage, a downloadable file, an online form, a video instruction, and more.
9. Private Chat - communicate with other users privately, in a one-on-one conversation (you can turn it on/off to your liking)
10. Plugin - create one or many rooms directly from the plugin
...
== Changelog ==
31/JAN/2024
- Facbook integration with newest SDK.
- New WP version
